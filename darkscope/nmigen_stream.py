from nmigen import *
from nmigen.hdl.rec import Record, Layout, Direction, DIR_FANOUT, DIR_FANIN, DIR_NONE
...
class StreamReducer(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        # need exactly one storage element equal to the input width
        ...
        # on a write, update the counter to its max value and set valid on the output
        with m.If(we):
        ...
        with m.If(re):
            next_counter = counter - input_width
